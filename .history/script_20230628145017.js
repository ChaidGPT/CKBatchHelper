const teaSelection = document.getElementById('teaSelection');
    ...
    function updateIngredientQuantities(tea) {
      ...
      const baseQuantities = {
        ...
        // check this recipe
        leo: {calendula: 3, hawthornLeaf: 5, mullein: 1, rosePetals: 4, lemonPeel: 3, lemonBalm: 2, gingerRoot: 3},
        // check this recipe
        libra: {rosePetals: 4, passionFlower: 3, rooibos: 5, nettleLeaf: 4, honeysuckle: 2},
